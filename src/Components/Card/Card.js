...
import { addToCart, addFavoriteAsync, removeFavoriteAsync } from "../../Redux/productSlice";
...
const Card = ({ object }) => {
  ...
  let [heartSelected, setHeartSelected] = useState(favoriteState.find(p => p.id === object.id));
